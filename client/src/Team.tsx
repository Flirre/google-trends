...
class Team extends React.Component<ITeamProps, ITeamState> {
  ...
  public SearchCompnent = () => (
    <div className="chart-container">
      <div className="input">
        <Input
          action={<Button icon="search" onClick={this.updateSearchTerm} />}
      ...
      <div className={`${this.props.color} player ${this.props.className}`}>
        ...
        {this.props.ready !== 1 || !this.props.waiting ? (
          <>
            ...
            {this.props.type === Types.Point ? <this.PointComponent /> : null}
            {this.props.type === Types.Search ? <this.SearchCompnent /> : null}
            {this.props.type === Types.Trend ? <this.ChartComponent /> : null}
          </>
        ) : (
          <>
            <div className="teamContainer">
